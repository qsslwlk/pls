    ...
    <PageShell>
      ...
      <Container className="pt-20">
        <SectionHeading number="01" label="Pitch" title="Le programme parfait.">
          <p>
            Une intelligence artificielle conçue pour écrire le programme électoral parfait propulse
            une ministre médiocre à la présidence de la République. Lorsque l'IA commence à
            gouverner à sa place, le pays bascule progressivement dans l'absurde.
          </p>
        </SectionHeading>
        ...
        <SectionHeading number="02" label="Synopsis" title="Synopsis.">
          ...
          <p className="mt-4">
            ...
            assistance et gouvernement disparaît. La pièce suit simultanément l'ascension politique
            de la Présidente, la dérive technocratique du pouvoir, la trajectoire de Gérard —
            employé ordinaire dépassé par les événements — et l'effacement progressif des médiations
            humaines.
          </p>
        </SectionHeading>

        <SectionHeading number="03" label="Note d'intention" title="L'humour comme outil critique.">
          <p>
            Gilberte se situe à la croisée de la satire politique, de la comédie sociale, du théâtre
            contemporain et de la critique du solutionnisme technologique. Le rire y est un outil
            d'analyse, non un effet décoratif.
          </p>
        ...
        <SectionHeading number="06" label="Calendrier" title="Calendrier de création.">
          <ul className="rule-t mt-2">
            <li className="rule-b py-5 grid md:grid-cols-12 gap-3">
              ...
              <span className="md:col-span-9">Écriture · Lectures publiques · Pré-production</span>
            </li>
            <li className="rule-b py-5 grid md:grid-cols-12 gap-3 text-muted-foreground">
              ...
              <span className="md:col-span-9">Résidences · Recherches scénographiques — TODO</span>
            </li>
            <li className="rule-b py-5 grid md:grid-cols-12 gap-3 text-muted-foreground">
              <span className="md:col-span-3 label-admin">À venir</span>
