  ...
  head: () => ({
    meta: [
      ...
      { title: "PLS — Plateforme de Liaisons Situationnelles" },
      {
        name: "description",
        content:
          "PLS — Plateforme de Liaisons Situationnelles. Compagnie de création théâtrale contemporaine. Première création : Gilberte, comédie satirique d'Évariste Lorrain.",
      },
      { name: "author", content: "PLS" },
      { property: "og:site_name", content: "PLS" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Compagnie de création théâtrale contemporaine produisant la pièce Gilberte.",
        }),
      },
    ],
  }),
